...
Character::Character()
{
    ...
    countdown = 0; shooting = 0; reloading = 0; bullet_remaining = 30; reload_cnt = 0;
}
...
void Character::charrender()
{
    ...
    if( reload_cnt == RELOAD_TOTAL ){ reload_cnt = 0; reloading = 0; bullet_remaining = 30;}
    stringstream ss;
    ss << reload_cnt;
    ...
    SDL_RenderDrawPoint( gRenderer, mPosX + CHAR_HITBOX_RADIUS, mPosY + CHAR_HITBOX_RADIUS );
}
